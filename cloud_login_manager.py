...
class Ui_cloud_login_manager(object):
    def setupUi(self, cloud_login_manager):
        ...
        cloud_login_manager.resize(645, 530)
        ...
        self.mfa_FR_PushButton = QtWidgets.QPushButton(self.cloud_buttons_frame)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setItalic(True)
        self.mfa_FR_PushButton.setFont(font)
        self.mfa_FR_PushButton.setObjectName("mfa_FR_PushButton")
        self.verticalLayout.addWidget(self.mfa_FR_PushButton)
        self.mfa_PL_PushButton = QtWidgets.QPushButton(self.cloud_buttons_frame)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setItalic(True)
        self.mfa_PL_PushButton.setFont(font)
        self.mfa_PL_PushButton.setObjectName("mfa_PL_PushButton")
        self.verticalLayout.addWidget(self.mfa_PL_PushButton)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 645, 18))
    ...
    def retranslateUi(self, cloud_login_manager):
        ...
        self.mfa_pushbutton.setText(_translate("cloud_login_manager", "MFA (RKI)"))
        self.mfa_FR_PushButton.setText(_translate("cloud_login_manager", "MFA (Factory Reset)"))
        self.mfa_PL_PushButton.setText(_translate("cloud_login_manager", "MFA (Playlist)"))
